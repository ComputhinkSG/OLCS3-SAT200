...
count = 1
while count < 6:  # this condition is true, then repeat
    print(count)

    #count = count + 1   # increment the value of count inside this loop
    count += 1
    # the variable count is equal to value of count + 1
